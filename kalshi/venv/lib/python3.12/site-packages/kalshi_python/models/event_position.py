...
class EventPosition(object):
    ...
    def event_exposure(self, event_exposure):
        ...
        if event_exposure is None:
            raise ValueError(
                "Invalid value for `event_exposure`, must not be `None`"
            )  # noqa: E501
    ...
    def fees_paid(self, fees_paid):
        ...
        if fees_paid is None:
            raise ValueError(
                "Invalid value for `fees_paid`, must not be `None`"
            )  # noqa: E501
    ...
    def realized_pnl(self, realized_pnl):
        ...
        if realized_pnl is None:
            raise ValueError(
                "Invalid value for `realized_pnl`, must not be `None`"
            )  # noqa: E501
    ...
    def resting_order_count(self, resting_order_count):
        ...
        if resting_order_count is None:
            raise ValueError(
                "Invalid value for `resting_order_count`, must not be `None`"
            )  # noqa: E501
    ...
    def total_cost(self, total_cost):
        ...
        if total_cost is None:
            raise ValueError(
                "Invalid value for `total_cost`, must not be `None`"
            )  # noqa: E501
