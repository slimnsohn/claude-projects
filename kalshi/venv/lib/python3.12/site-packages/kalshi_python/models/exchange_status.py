...
class ExchangeStatus(object):
    ...
    """
    swagger_types = {"exchange_active": "bool", "trading_active": "bool"}
    ...
    def exchange_active(self, exchange_active):
        ...
        if exchange_active is None:
            raise ValueError(
                "Invalid value for `exchange_active`, must not be `None`"
            )  # noqa: E501
    ...
    def trading_active(self, trading_active):
        ...
        if trading_active is None:
            raise ValueError(
                "Invalid value for `trading_active`, must not be `None`"
            )  # noqa: E501
