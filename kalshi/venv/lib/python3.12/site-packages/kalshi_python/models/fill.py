...
class Fill(object):
    ...
    def created_time(self, created_time):
        ...
        if created_time is None:
            raise ValueError(
                "Invalid value for `created_time`, must not be `None`"
            )  # noqa: E501
    ...
    def is_taker(self, is_taker):
        ...
        if is_taker is None:
            raise ValueError(
                "Invalid value for `is_taker`, must not be `None`"
            )  # noqa: E501
    ...
    def no_price(self, no_price):
        ...
        if no_price is None:
            raise ValueError(
                "Invalid value for `no_price`, must not be `None`"
            )  # noqa: E501
    ...
    def side(self, side):
        ...
        if side is None:
            raise ValueError(
                "Invalid value for `side`, must not be `None`"
            )  # noqa: E501
        allowed_values = ["yes", "no", ""]  # noqa: E501
        if side not in allowed_values:
            raise ValueError(
                "Invalid value for `side` ({0}), must be one of {1}".format(  # noqa: E501
                    side, allowed_values
                )
            )
    ...
    def yes_price(self, yes_price):
        ...
        if yes_price is None:
            raise ValueError(
                "Invalid value for `yes_price`, must not be `None`"
            )  # noqa: E501
