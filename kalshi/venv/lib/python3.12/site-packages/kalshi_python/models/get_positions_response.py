...
class GetPositionsResponse(object):
    ...
    def __init__(
        self, cursor=None, event_positions=None, market_positions=None
    ):  # noqa: E501
    ...
    def event_positions(self, event_positions):
        ...
        if event_positions is None:
            raise ValueError(
                "Invalid value for `event_positions`, must not be `None`"
            )  # noqa: E501
    ...
    def market_positions(self, market_positions):
        ...
        if market_positions is None:
            raise ValueError(
                "Invalid value for `market_positions`, must not be `None`"
            )  # noqa: E501
