...
class Market(object):
    ...
    def can_close_early(self, can_close_early):
        ...
        if can_close_early is None:
            raise ValueError(
                "Invalid value for `can_close_early`, must not be `None`"
            )  # noqa: E501
    ...
    def close_time(self, close_time):
        ...
        if close_time is None:
            raise ValueError(
                "Invalid value for `close_time`, must not be `None`"
            )  # noqa: E501
    ...
    def event_ticker(self, event_ticker):
        ...
        if event_ticker is None:
            raise ValueError(
                "Invalid value for `event_ticker`, must not be `None`"
            )  # noqa: E501
    ...
    def expiration_time(self, expiration_time):
        ...
        if expiration_time is None:
            raise ValueError(
                "Invalid value for `expiration_time`, must not be `None`"
            )  # noqa: E501
    ...
    def expiration_value(self, expiration_value):
        ...
        if expiration_value is None:
            raise ValueError(
                "Invalid value for `expiration_value`, must not be `None`"
            )  # noqa: E501
    ...
    def last_price(self, last_price):
        ...
        if last_price is None:
            raise ValueError(
                "Invalid value for `last_price`, must not be `None`"
            )  # noqa: E501
    ...
    def liquidity(self, liquidity):
        ...
        if liquidity is None:
            raise ValueError(
                "Invalid value for `liquidity`, must not be `None`"
            )  # noqa: E501
    ...
    def no_ask(self, no_ask):
        ...
        if no_ask is None:
            raise ValueError(
                "Invalid value for `no_ask`, must not be `None`"
            )  # noqa: E501
    ...
    def no_bid(self, no_bid):
        ...
        if no_bid is None:
            raise ValueError(
                "Invalid value for `no_bid`, must not be `None`"
            )  # noqa: E501
    ...
    def open_interest(self, open_interest):
        ...
        if open_interest is None:
            raise ValueError(
                "Invalid value for `open_interest`, must not be `None`"
            )  # noqa: E501
    ...
    def open_time(self, open_time):
        ...
        if open_time is None:
            raise ValueError(
                "Invalid value for `open_time`, must not be `None`"
            )  # noqa: E501
    ...
    def previous_price(self, previous_price):
        ...
        if previous_price is None:
            raise ValueError(
                "Invalid value for `previous_price`, must not be `None`"
            )  # noqa: E501
    ...
    def previous_yes_ask(self, previous_yes_ask):
        ...
        if previous_yes_ask is None:
            raise ValueError(
                "Invalid value for `previous_yes_ask`, must not be `None`"
            )  # noqa: E501
    ...
    def previous_yes_bid(self, previous_yes_bid):
        ...
        if previous_yes_bid is None:
            raise ValueError(
                "Invalid value for `previous_yes_bid`, must not be `None`"
            )  # noqa: E501
    ...
    def risk_limit_cents(self, risk_limit_cents):
        ...
        if risk_limit_cents is None:
            raise ValueError(
                "Invalid value for `risk_limit_cents`, must not be `None`"
            )  # noqa: E501
    ...
    def strike_type(self, strike_type):
        ...
        if strike_type not in allowed_values:
            raise ValueError(
                "Invalid value for `strike_type` ({0}), must be one of {1}".format(  # noqa: E501
                    strike_type, allowed_values
                )
            )
    ...
    def ticker(self, ticker):
        ...
        if ticker is None:
            raise ValueError(
                "Invalid value for `ticker`, must not be `None`"
            )  # noqa: E501
    ...
    def volume(self, volume):
        ...
        if volume is None:
            raise ValueError(
                "Invalid value for `volume`, must not be `None`"
            )  # noqa: E501
    ...
    def volume_24h(self, volume_24h):
        ...
        if volume_24h is None:
            raise ValueError(
                "Invalid value for `volume_24h`, must not be `None`"
            )  # noqa: E501
    ...
    def yes_ask(self, yes_ask):
        ...
        if yes_ask is None:
            raise ValueError(
                "Invalid value for `yes_ask`, must not be `None`"
            )  # noqa: E501
    ...
    def yes_bid(self, yes_bid):
        ...
        if yes_bid is None:
            raise ValueError(
                "Invalid value for `yes_bid`, must not be `None`"
            )  # noqa: E501
