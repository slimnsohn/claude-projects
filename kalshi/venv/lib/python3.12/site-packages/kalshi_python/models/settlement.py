...
class Settlement(object):
    ...
    def market_result(self, market_result):
        ...
        if market_result is None:
            raise ValueError(
                "Invalid value for `market_result`, must not be `None`"
            )  # noqa: E501
    ...
    def no_count(self, no_count):
        ...
        if no_count is None:
            raise ValueError(
                "Invalid value for `no_count`, must not be `None`"
            )  # noqa: E501
    ...
    def no_total_cost(self, no_total_cost):
        ...
        if no_total_cost is None:
            raise ValueError(
                "Invalid value for `no_total_cost`, must not be `None`"
            )  # noqa: E501
    ...
    def revenue(self, revenue):
        ...
        if revenue is None:
            raise ValueError(
                "Invalid value for `revenue`, must not be `None`"
            )  # noqa: E501
    ...
    def settled_time(self, settled_time):
        ...
        if settled_time is None:
            raise ValueError(
                "Invalid value for `settled_time`, must not be `None`"
            )  # noqa: E501
    ...
    def yes_count(self, yes_count):
        ...
        if yes_count is None:
            raise ValueError(
                "Invalid value for `yes_count`, must not be `None`"
            )  # noqa: E501
    ...
    def yes_total_cost(self, yes_total_cost):
        ...
        if yes_total_cost is None:
            raise ValueError(
                "Invalid value for `yes_total_cost`, must not be `None`"
            )  # noqa: E501
